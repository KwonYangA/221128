...
// 자바스크립트에서도 사용자 정의 객체를 만들수 있다. -> function
// 사용자 정의 함수를 정의할 때는 prototype사용
// prototype을 사용하여 함수를 정의한다는건 사용자 정의 API를 만드는 것이다. 
...
//객체를 선언할 때도 function
//객체가 정의하는 함수를만들때는 prototype
//바닐라스크립(순수한)에서는 전변 선언 없이도 생성자에서 초기화 가능함
// 나도 API(객체와 함수 그리고 변수[var]를 만들 수 잇는 개발자가 되자)
function Sonata(){
  this.wheelNum
  this.speed
  this.carName
